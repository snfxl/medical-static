<template>
  <div class="margin-top">
    <el-table
      ...
      <el-table-column prop="outStockId" label="出库单号"/>
      <el-table-column prop="outStockType" label="出库类型"/>
      ...
      <el-table-column prop="outStockWorker" label="出库人员"/>
...
export default {
  ...
  methods: {
    ...
    toOutStockNotPassCheck() {
      this.$router.push('/home/outStockNotPassCheck/10')
    },
    //编辑未审核
    toOutStockNotCheck() {
      this.$router.push('/home/outStockNotCheck/10')
    },
    //再次出库
    outStockAgain() {
      this.$router.push('/home/outStockNotCheck/10')
